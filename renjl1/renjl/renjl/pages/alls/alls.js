...
<div style="line-height:50rpx;width:94%; margin-left:3%; margin-top:5%;font-size:30rpx; font-family:微软雅黑;">
 其他语言：西班牙语、克罗地亚语、塞尔维亚语。
    ...
    var html2 = `<div style="text-align:center;">
    <img src="../../images/one.jpg" width="100px" height="50px" />
</div>
<div style="line-height:50rpx;width:94%; margin-left:3%; font-size:30rpx; font-family:微软雅黑;">姓名：Nemanja Pantelic</div>
<div style="line-height:50rpx;width:94%; margin-left:3%; font-size:30rpx; font-family:微软雅黑; color:#974A38; padding-bottom:30rpx;">经济学硕士</div>
<div style="width:100%; height:20rpx; background:#FFF;"></div>
<div class="jieshao">── ── 基本信息 ── ──</div>
...
<div style="line-height:50rpx;width:94%; margin-left:3%; font-size:30rpx; font-family:微软雅黑;">
 高智商富有理性思维以及较强的时间管理意识。
</div>
<div style="line-height:50rpx;width:94%; margin-left:3%; font-size:29rpx; font-family:微软雅黑;">
商业和法律研究学院，贝尔格莱德联合大学毕业。
</div>
